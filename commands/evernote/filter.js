...
exports.command = "evernote-filter [file]";
exports.describe =
  "filter documents by tag, date, and title from evernote export";
exports.builder = (yargs) => {
  yargs
    ...
    .option("title", {
      demandOption: false,
      describe:
        "Filters notes if title includes the given value. Case-insensitive.",
      type: "string",
    })
    .option("o", {
      alias: "output",
